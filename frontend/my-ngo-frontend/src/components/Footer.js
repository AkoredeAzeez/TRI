        ...
        <div className="footer-grid-21 stagger-children-21">
          ...
          <div className="footer-section-21">
            ...
            <div className="social-links-21">
              <a href="#" className="social-icon-21">
          ...
          <div className="footer-section-21">
            ...
            <div className="contact-info-21">
              <div className="contact-item-21">
                ...
                <span className="footer-link-21">Theredrawinitiative.org</span>
              </div>
              <div className="contact-item-21">
                <div className="contact-icon-21">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                ...
                <span className="footer-link-21">+2349090343073</span>
              </div>
              <div className="contact-item-21">
                <div className="contact-icon-21">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                ...
                <span className="footer-link-21">Lagos, Nigeria</span>
              </div>
            </div>
          </div>
          ...
          <div className="footer-section-21">
            ...
            <div className="newsletter-form-21">
              <input 
                type="email" 
                placeholder="Enter your email" 
                className="newsletter-input-21"
              />
              <button className="newsletter-button-21">
                Subscribe
              </button>
            </div>
        ...
        <div className="footer-bottom-21">
          <div className="footer-bottom-content-21">
            <div className="footer-links-21">
              <a href="#" className="footer-link-21 footer-link-small-21">Privacy Policy</a>
              <a href="#" className="footer-link-21 footer-link-small-21">Terms of Service</a>
              <a href="#" className="footer-link-21 footer-link-small-21">Cookie Policy</a>
              <a href="#" className="footer-link-21 footer-link-small-21">Accessibility</a>
            </div>
